...
IPAddress::IPAddress(QWidget* parent) : QWidget(parent) {
    ...
    labDot1->setText(".");
    labDot1->setFont(QFont("Courier New", 14, QFont::Bold));
    labDot2 = new QLabel;
    labDot2->setAlignment(Qt::AlignBottom);
    labDot2->setText(".");
    labDot2->setFont(QFont("Courier New", 14, QFont::Bold));
    labDot3 = new QLabel;
    labDot3->setAlignment(Qt::AlignBottom);
    labDot3->setText(".");
    labDot3->setFont(QFont("Courier New", 14, QFont::Bold));
    ...
    txtIP1->setFont(QFont("Courier New", 12, QFont::Bold));
//    txtIP1->setPlaceholderText("192");
    ...
    txtIP2->setFont(QFont("Courier New", 12, QFont::Bold));
//    txtIP2->setPlaceholderText("168");
    ...
    txtIP3->setFont(QFont("Courier New", 12, QFont::Bold));
//    txtIP3->setPlaceholderText("1");
    ...
    txtIP4->setFont(QFont("Courier New", 12, QFont::Bold));
